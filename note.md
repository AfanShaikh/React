# React `Notes`
**React is a JavaScript library used for building user interfaces (UIs), especially single-page applications.**

**1.Developed by Facebook, React helps create fast and dynamic web apps.**

**2.It uses components (reusable UI parts) and a virtual DOM to update web pages efficiently.**

**3.React focuses only on the view layer of an application.**

**4.React was created by Jordan Walke, a software engineer at Facebook, and it was released in 2013.**

**Creator: Jordan Walke (Facebook engineer)**
...
| ----------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **JSX (JavaScript XML(Extensible Markup Language))**      | A syntax extension that allows writing HTML elements in JavaScript.                                | `jsx import React from "react";  function App() {   return <h1>Hello, JSX!</h1>; } export default App; `                                                                                                                                         |
